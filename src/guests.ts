const guestData = [
    ...
    "Faryn Borella, Guest",
    "Carolina Zamora, Logan Kelley",
    "Eliese Rulifson, Dave Brisson, Bo Brisson-Rulifson",
    "Jaime McConachie, Guest",
    "Amanda Astey, Caleb Astey",
    "Sarah Al Sayadi, Robert Mitchell",
    "Matt Mistele,Happy Yang",
    "Rachel Wright,Sean Correa",
    "Sarah Cronin, Guest",
    "Elliya Cutler, Ross Kettleson",
];
